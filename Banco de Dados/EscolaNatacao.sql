...
INSERT INTO
    Professores (nome, especialidade, data_contratacao)
VALUES
    ('Ricardo Silva', 'Nado Borboleta', '2023-01-15'),
    ('Beatriz Souza', 'Infantil', '2023-05-10');

INSERT INTO
    Niveis (descricao, preco_mensal)
VALUES
...
INSERT INTO
    Alunos (nome, data_nascimento, cpf)
VALUES
    (
        'João Pedro Carvalho',
        '2015-03-20',
...
INSERT INTO
    Turmas (id_professor, id_nivel, horario, dias_semana)
VALUES
    (2, 1, '09:00:00', 'Ter/Qui'),
    (1, 3, '18:30:00', 'Seg/Qua/Sex');

INSERT INTO
    Matriculas (id_alumno, id_turma)
VALUES
    (1, 1),
    (2, 2),
    (3, 2);
